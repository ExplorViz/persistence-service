 ...
 * @param parentBuildingId The ID of the building in which this function resides. Functions must
 *     always have a parent building, although it may be transitively via parent classes
