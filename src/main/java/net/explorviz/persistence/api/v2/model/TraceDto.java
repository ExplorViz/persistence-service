 ...
 * @param duration            Duration of the trace, either milliseconds or nanoseconds depending on
 *                            format of start and end timestamps
 ...
 */
public record TraceDto(String landscapeToken, String traceId, String gitCommitChecksum,
                       long startTime, long endTime, long duration, long overallRequestCount,
                       long traceCount, List<SpanDto> spanList) {

  public TraceDto(final Trace ogmTrace, final String landscapeToken,
      final String gitCommitChecksum) {
    this(landscapeToken, ogmTrace.getTraceId(), gitCommitChecksum, ogmTrace.getStartTime(),
        ogmTrace.getEndTime(), ogmTrace.getEndTime() - ogmTrace.getStartTime(), 1, 1,
